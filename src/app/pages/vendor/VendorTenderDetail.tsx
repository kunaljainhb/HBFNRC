...
import { Calendar, Clock, FileText, Download, ArrowLeft, Send, MessageSquare, ShieldAlert, Briefcase, Lock, Globe, Eye } from 'lucide-react';
...
export default function VendorTenderDetail() {
  ...
  if (!tender) {
    return (
      <div className="flex flex-col items-center justify-center py-20 bg-white rounded-card shadow-card text-center">
    ...
    <div className="space-y-8 font-sans text-start">
      <div className="flex items-center justify-between">
        <Button
          ...
          className="gap-2 text-gray-500 hover:text-gray-900 transition-colors cursor-pointer"
        >
            ...
            <CardContent className="pt-1 px-6 pb-6 space-y-4">
              ...
              <div>
                ...
                <div className="text-sm font-medium text-gray-800">
                  {tender.category.map(cat => t(cat)).join(', ')}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                ...
                <div>
                  ...
                  <div className="font-medium text-gray-800 flex items-center gap-1.5">
                    ...
                    {formatDate(tender.submissionDeadline, language)}
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="pt-1 px-6 pb-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                <div>
                  ...
                  <div className="font-medium text-gray-800 flex items-center gap-1.5">
                    <Calendar className="h-4 w-4 text-gray-400" />
                    {tender.projectStartDate ? formatDate(tender.projectStartDate, language) : t('Not specified')}
                  </div>
                </div>
                <div>
                  ...
                  <div className="font-medium text-gray-800 flex items-center gap-1.5">
                    <Calendar className="h-4 w-4 text-gray-400" />
                    {tender.projectEndDate ? formatDate(tender.projectEndDate, language) : t('Not specified')}
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col h-[520px]">
                ...
                <div className="flex gap-3 items-end">
                  <div className="flex-1 relative">
                    <Textarea
                      placeholder={t('Type your clarification question here...')}
                      value={message}
            ...
            <Card className="border border-dashed border-gray-200">
              <CardContent className="py-16 text-center max-w-xl mx-auto flex flex-col items-center">
                <h3 className="text-xl font-bold text-gray-800 mb-2">
                  {t('No Proposal Submitted')}
                </h3>
                <p className="text-sm text-gray-500 leading-relaxed mb-8">
                  {t("You haven't submitted a proposal yet.")} <br/>
                  {t('Review the Tender details and submit your proposal before the deadline.')}
                </p>
                {isClosed ? (
                  <Button disabled size="lg" className="w-full sm:w-auto font-semibold">
                    {t('Submission Period Ended')}
                  </Button>
                ) : (
                  <Button
                    size="lg"
