...
import VendorOnboardingReport from '@/app/pages/admin/VendorOnboardingReport';
import VendorTenderReport from '@/app/pages/admin/VendorTenderReport';
import TenderSummaryReport from '@/app/pages/admin/TenderSummaryReport';
...
function AppRoutes() {
  ...
  if (path === '/admin/reports/vendor-onboarding') return <AdminLayout><VendorOnboardingReport /></AdminLayout>;
  if (path === '/admin/reports/vendor-tender') return <AdminLayout><VendorTenderReport /></AdminLayout>;
  if (path === '/admin/reports/tender-summary') return <AdminLayout><TenderSummaryReport /></AdminLayout>;
